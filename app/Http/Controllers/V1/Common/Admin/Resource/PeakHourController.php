...
class PeakHourController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $timezone = isset($state_id->state_id) ? State::find($state_id->state_id)->timezone : 'Asia/Kolkata';

            $PeakHour->start_time = (Carbon::createFromFormat('H:i:s', (Carbon::parse($request->start_time)->format('H:i:s')), $timezone))->setTimezone('Asia/Kolkata');
            $PeakHour->end_time   = (Carbon::createFromFormat('H:i:s', (Carbon::parse($request->end_time)->format('H:i:s')), $timezone))->setTimezone('Asia/Kolkata');
