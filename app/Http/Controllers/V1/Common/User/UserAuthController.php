...
class UserAuthController extends Controller
{
    ...
    public function signup(Request $request)
    {
        ...
        if (null != $registeredEmail && null != $registeredMobile) {
        ...
        if (null != $registeredEmailNormal) {
            $validator->errors()->add('email', 'User already registered with given email-Id!');
            throw new \Illuminate\Validation\ValidationException($validator);
        }

        if (null != $registeredMobileNormal) {
            $validator->errors()->add('mobile', 'User already registered with given mobile number!');
            throw new \Illuminate\Validation\ValidationException($validator);
        }
        ...
        $credentials = ['email' => $this->cusencrypt($User->email, env('DB_SECRET')), 'password' => (null != $request->social_unique_id) ? $request->social_unique_id : $request->password, 'company_id' => $User->company_id];
