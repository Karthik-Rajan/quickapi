...
class ServiceController extends Controller
{
    ...
    public function create_service(Request $request)
    {
        $this->validate($request, [
            ...
            'service_ids.*' => 'integer|exists:service.services,id',
            's_latitude'    => 'required',
        ...
        try {
            ...
            if ("CASH" != $request->payment_mode) {
                if (0 == $totalAmount) {
                    ...
                    $requestData = ['type' => 'SERVICE', 'room' => 'room_' . $serviceRequest->company_id, 'id' => $serviceRequest->id, 'city' => (0 == $setting->demo_mode) ? $serviceRequest->city_id : 0, 'user' => $serviceRequest->user_id];
                    ...
                    switch ($paymentMode) {
                        case 'CARD':
                            ...
                            if (null == $card) {
                                $card = Card::where('user_id', $serviceRequest->user_id)->first();
                            }
    ...
    public function webproviderservice(Request $request, $id)
    {
        ...
        try {
            $storetype = Service::with(['provideradminservice' => function ($query) use ($id) {
