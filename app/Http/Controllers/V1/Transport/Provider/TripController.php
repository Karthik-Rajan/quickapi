...
class TripController extends Controller
{
    ...
    public function gettripdetails(Request $request, $id)
    {
        try {
            ...
            $jsonResponse         = [];
            $jsonResponse['type'] = 'transport';
            $providerrequest      = RideRequest::with(['payment', 'ride', 'user', 'service_type',
    ...
    public function get_ride_request_dispute(Request $request, $id)
    {
        ...
        if ($ride_request_dispute) {
            $ride_request_dispute->created_time = (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $ride_request_dispute->created_at, 'Asia/Kolkata'))->setTimezone($ride_request_dispute->request->timezone)->format(Helper::dateFormat());
