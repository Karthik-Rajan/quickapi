...
class HomeController extends Controller
{
    ...
    public function get_ride_lost_item(Request $request, $id)
    {
        ...
        if (count($ride_lost_item) > 0) {
            $ride_lost_item->created_time = (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $ride_lost_item->created_at, 'Asia/Kolkata'))->setTimezone($timezone)->format(Helper::dateFormat());
        }
