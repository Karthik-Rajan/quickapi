...
class ProviderWallet extends BaseModel
{
    ...
    public function getCreatedTimeAttribute()
    {
        ...
        return (isset($this->attributes['created_at'])) ? (\Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $this->attributes['created_at'], 'Asia/Kolkata'))->setTimezone($timezone)->format('Y-m-d H:i:s') : '';
    }
