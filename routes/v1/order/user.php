...
$router->group(['middleware' => 'authless:user'], function ($app) {
    ...
    $app->get('/druglist', 'V1\Order\User\HomeController@drugList');
    $app->get('/drug/details/{id}', 'V1\Order\User\HomeController@drugDetails');
    $app->get('/store/new-arrived', 'V1\Order\User\HomeController@newArrival');
    $app->get('/brand/{id}/items', 'V1\Order\User\HomeController@brandItems');
...
$router->group(['middleware' => 'auth:user'], function ($app) {
    ...
    $app->post('/store/addprescription', 'V1\Order\User\HomeController@addPrescription');
    ...
    $app->get('/delivery-time/{id}', 'V1\Order\User\HomeController@orderDeliveryTime');
